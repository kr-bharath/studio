...
export function HomeSection() {
  const welcomeMessage = "I’m a Data Scientist, Data Analyst, and Automation Specialist with 5 years of experience in QA automation and data science, specializing in machine learning, predictive modeling, and statistical analysis to drive efficiency and innovation";
